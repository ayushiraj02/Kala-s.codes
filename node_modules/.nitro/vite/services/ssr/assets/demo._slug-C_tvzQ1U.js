import { r as templates } from "./templates-Bdo8-Tm_.js";
import { n as Route } from "./router-_k2F9VAr.js";
import { a as cn, i as Scaled, o as SitePreview } from "./Frames-sRqPEZnx.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Layers, Mail, Monitor, Smartphone, Sparkles, Tablet, Tag } from "lucide-react";
//#region src/routes/demo.$slug.tsx?tsr-split=component
var widths = {
	desktop: 1280,
	tablet: 834,
	mobile: 390
		...
		children: [
			...
			/* @__PURE__ */ jsxs("nav", {
				...
				children: [
					...
					].map(([key, Icon, label]) => /* @__PURE__ */ jsx("button", {
						type: "button",
						"aria-label": label,
				...
				children: [
					/* @__PURE__ */ jsxs("header", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								["tablet", Tablet],
								["mobile", Smartphone]
							].map(([d, Icon]) => /* @__PURE__ */ jsx("button", {
								type: "button",
								onClick: () => setDevice(d),
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("section", {
							...
							children: [
								panel === "features" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("h2", {
									className: "text-lg",
									...
									children: template.features.map((f) => /* @__PURE__ */ jsxs("li", {
								...
								panel === "pricing" ? /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx("h2", {
										className: "text-lg",
								...
								panel === "customize" ? /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx("h2", {
										className: "text-lg",
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: Object.values(template.palette).map((c) => /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("section", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: related.map((t) => /* @__PURE__ */ jsx("li", {
