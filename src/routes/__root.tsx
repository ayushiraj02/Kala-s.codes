  ...
  head: () => ({
    meta: [
      ...
      { title: "Kala's.codes — Premium Web Design & Development Studio" },
      {
        name: "description",
        content:
          "Kala's.codes is a luxury web design studio crafting fast, high-converting websites for salons, clinics, hotels, restaurants and ambitious brands.",
      },
      { name: "author", content: "Kala's.codes" },
      { property: "og:title", content: "Kala's.codes — Premium Web Design Studio" },
      {
